...
data class Profile(
        ...
        var name: String? = "",
        var cName: String = "", //city name
        var nName: String = "", //country name
        var nCode: String = "", //country code
        var byPassInMain: Boolean = true, //is flow around
        var inSmart: Boolean = false, //is from smart list
        var agencys: String = "", //all proxys app's package name
        ...
        private class JsonParser(private val feature: Profile? = null) : ArrayList<Profile>() {
            ...
            private fun tryParse(json: JsonObject, fallback: Boolean = false): Profile? {
                ...
                return Profile().also {
                    ...
                    cName = json["cName"].optString?:""
                    nName = json["nName"].optString?:""
                    nCode = json["nCode"].optString?:""
                    ...
                    inSmart = json["inSmart"].optBoolean ?: inSmart
    ...
    fun copyFeatureSettingsTo(profile: Profile) {
        ...
        profile.byPassInMain = byPassInMain
        profile.agencys = agencys
        profile.inSmart = inSmart
        profile.cName = cName
        profile.nName = nName
        profile.nCode = nCode
    }
    ...
    fun serialize() {
        ...
        DataStore.privateStore.putString(Key.cName, cName)
        DataStore.privateStore.putString(Key.nName, nName)
        DataStore.privateStore.putString(Key.nCode, nCode)
        ...
        DataStore.privateStore.putBoolean(Key.byPassInMain, byPassInMain)
        DataStore.privateStore.putString(Key.agencys, agencys)
        ...
        DataStore.privateStore.putBoolean(Key.inSmart, inSmart)
    ...
    fun deserialize() {
        ...
        cName = DataStore.privateStore.getString(Key.cName) ?: ""
        nName = DataStore.privateStore.getString(Key.nName) ?: ""
        nCode = DataStore.privateStore.getString(Key.nCode) ?: ""
        ...
        agencys = DataStore.privateStore.getString(Key.agencys) ?: ""
        proxyApps = DataStore.proxyApps
        bypass = DataStore.bypass
        byPassInMain = DataStore.privateStore.getBoolean(Key.byPassInMain, true)
        ...
        inSmart = DataStore.privateStore.getBoolean(Key.inSmart, false)
